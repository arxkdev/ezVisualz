...
return function(uiInstance: GuiObject, speed: number, size: number)
    ...
    local strokeGradient = TextEffects.Gradient.new(mainStroke.Instance, TextEffects.Templates.Matrix.Color, TextEffects.Templates.Ghost.Transparency);
    ...
    return {mainGradient, mainStroke, strokeGradient};
end